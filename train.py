...
if __name__ == '__main__':
    ...
    parser.add_argument('--save-dir', type=str, default='exp/NCNet3', help='the dir where the model and ')
    ...
    parser.add_argument('--epochs', type=int, default=300, help='the number of total training epochs')
    ...
    parser.add_argument('--workers', type=int, default=2, help='the number of dataloader workers')
    ...
    model = NCNet(scale_factor=opt.SR_rate)
    ...
    valid_dataloader = create_dataloader('valid', opt.SR_rate, False, 1, shuffle=False, num_workers=0)
